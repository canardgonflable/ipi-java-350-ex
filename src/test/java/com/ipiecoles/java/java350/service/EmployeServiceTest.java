...
class EmployeServiceTest {
    ...
    @Test
    void testCalculPerformanceCommercialNull()throws EmployeException{
        String matricule = "CM0001";
        Long caTraite = null;
        Long objectifCa = 2500L;
        try {
    ...
    @Test
    void testCalculPerformanceCommercialNegatif() {
        String matricule = "CM0001";
        Long caTraite = -42L;
        Long objectifCa = 2500L;
        try {
    ...
    @Test
    void testCalculPerformanceCommercialObjectifNull() {
        String matricule = "CM0001";
        Long caTraite = 2500L;
    ...
    @Test
    void testCalculPerformanceCommercialObjectifNegatif() {
        String matricule = "CM0001";
        Long caTraite = 2500L;
        Long objectifCa = -42L;
        try {
